...
### IMPORTANT! THIS IS A DECOY CREATE ACCOUNT ROUTE - it prevents making new accounts in the demo app
...
### This is proper route to create new users:
# @userbase.route('/create', methods=['GET', 'POST'])
# def create():
#     if request.method == 'GET':
#         return render_template('userbase/create.html')
...
# Temporary route only for demonstrating the app
@userbase.route('/demo')
def info():
    return render_template('userbase/demo.html')